...
{
    internal partial class AndroidBidonInterstitialAd : IAndroidInterstitialAdListener
    {
        ...
        {
            _interstitialAdJavaObject.SafeCall("setInterstitialListener", new AndroidInterstitialAdListener(this));
        }
    }
}
#endif
